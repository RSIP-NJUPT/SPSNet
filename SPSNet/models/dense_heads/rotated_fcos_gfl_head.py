...
from SPSNet.registry import MODELS, TASK_UTILS
...
class RotatedFCOSGFLHead(FCOSHead):
    ...
    def __init__(self,
                 ...
                 bbox_coder: ConfigType = dict(type='mmrotate.DistanceAnglePointCoder'),
                 ...
                 loss_bbox: ConfigType = dict(
                     type='mmrotate.RotatedIoULoss', loss_weight=1.0),
